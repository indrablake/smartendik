                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-warning btn-sm" onclick="edit(<?php echo $q['tk_kls_level'] ?>)">Edit </button>
                                    <button onclick="hapus(<?php echo $q['tk_kls_level'] ?>)" class=" btn btn-sm btn-danger">Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div id="modalTambahKelas" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('MasterData/simpanTingkatKelas_ajax', ['class' => 'formSimpan']) ?>
...
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.sukses) {
                        ...
                        window.location.href = ("<?= base_url('MasterData/listTingkatKelas'); ?>")
                    }
                },
    ...
    function edit(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('MasterData/formEditTingkatKelas') ?>",
            data: {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('MasterData/hapusTingkatKelas_ajax') ?>",
                        data: {
