                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-outline-success btn-sm" onclick="edit(<?php echo $q['jenjang_kd'] ?>)">Edit </button>
                                    <button onclick="hapus(<?php echo $q['jenjang_kd'] ?>)" class=" btn btn-sm btn-outline-danger">Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div id="modalTambahJenjang" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('JenjangSekolah/simpanJenjangSekolah_ajax', ['class' => 'formSimpan']) ?>
...
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.sukses) {
                        ...
                        window.location.href = ("<?= base_url('JenjangSekolah/listJenjangSekolah'); ?>")
                    }
                },
    ...
    function edit(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('JenjangSekolah/formEditJenjang') ?>",
            data: {
                jenjangID: id
            },
            dataType: 'json',
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('JenjangSekolah/hapusJenjang_ajax') ?>",
                        data: {
                            jenjangID: jenjangID
                        },
                        dataType: "json",
