                    ...
                    <form id="submit">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul_berita" class="form-control" value="<?php echo $resultQuery->berita_judul; ?>" val>
                            </div>
                            <div class="form-group">
                                <label>Tanggal :</label>
                                <input type="date" readonly name="tanggal_berita" class="form-control" value="<?php echo $resultQuery->berita_tgl_kirim ?>">
                            </div>
                            <div class="form-group">
                                <label>Tanggal Expired:</label>
                                <input type="date" readonly name="tanggal_expire" class="form-control" value="<?php echo $resultQuery->berita_tgl_expired ?>">
                            </div>
                            ...
                            <div class=" form-group">
                                ...
                                <?php if ($resultQuery->berita_video == '') { ?>
                                    <input type="hidden" name="file_beritaOld" value="<?php echo $resultQuery->berita_video ?>">
                                <?php } else { ?>
                                    <input type="hidden" name="file_beritaOld" value="<?php echo $resultQuery->berita_gambar ?>">
                                <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="isi_berita" id="ckeditor" rows="4" cols="4">
