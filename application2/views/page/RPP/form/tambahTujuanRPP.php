                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-10">
                            <select data-placeholder="Pilih RPP" id="rppID" class="form-control form-control-select2" data-fouc name="rppID[]">
                                <?php $queryGroup = $this->db->query("SELECT rt.thn_ajar_periode,rt.thn_ajar_kd,rpp.rpp_id,rpp.rpp_semester,rpp.rpp_materi_pokok,rpp_status FROM rpp INNER JOIN ref_tahun_pelajaran rt ON rt.thn_ajar_kd=rpp.thn_ajar_kd where rpp.rpp_status='1'")->result_array();
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#submit').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>RPP/simpanRPPTujuan_ajax',
                type: "post",
                ...
                success: function(data) {
                    ...
                    swal({
                        icon: 'success',
                        title: "Konfirmasi",
                        text: "Tujuan Pembelajaran RPP Berhasil Ditambahkan"
                    });
                    window.location.href = ("<?= base_url('RPP/listTujuanRPP'); ?>")
                }
            });
        });
