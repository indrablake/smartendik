    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="<?php echo base_url() ?>RPP/formTambahTujuanRPP" class="btn btn-default btn-sm">Tambah Data</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function load_data(query) {
        $.ajax({
            url: "<?php echo base_url(); ?>RPP/fetchTujuan",
            method: "POST",
            data: {
                query: query
            },
...
<script>
    function showData() {
        table = $('#my_data').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url('rpp/ambilDataTujuanRPP') ?>",
                "type": "POST",
                "data": {
                    "rppTPID": $("#rpphid").val()
                }
    ...
    function edit(id) {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('RPP/formEditTujuanRPP') ?>",
            data: {
                rppTPID: id
            },
            dataType: 'json',
    ...
    function hapus(rppTPID) {

        swal({
                title: "Hapus",
                text: "Yakin menghapus data tujuan pembelajaran RPP ?",
                icon: "warning",
                buttons: true,
                dangerMode: true,
                showCancelButton: true,
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('RPP/hapusTujuanRPP_ajax') ?>",
                        data: {
                            rppTPID: rppTPID
                        },
                        dataType: "json",
