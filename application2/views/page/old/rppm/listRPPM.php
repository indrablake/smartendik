    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <button class="btn btn-default" data-toggle="modal" data-target="#modalTambahRPPM">
...
<div class="content">
    ...
    <?php echo form_open('RPPM/deleteMultiple_ajax', ['class' => 'formHapus']); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card" style="padding: 1em;">
                <table class="table datatable-basic" id="my_data" style="padding:1em">
                    <thead>
                        <tr>
...
<div id="modalTambahRPPM" class="modal fade modalTambahRPPM" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                <h5 class="modal-title">Tambah RPPM</h5>
            ...
            <div class="modal-body">
                ...
                <?php echo form_open('RPPM/simpanRPPM_ajax', ['class' => 'formSimpan']) ?>
                <fieldset>
...
<script>
    function showData() {
        table = $('#my_data').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url('rppm/ambilDataRPPM') ?>",
                "type": "POST"
            },
    ...
    function edit(id) {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('RPPM/formEditRPPM') ?>",
            data: {
                rppmID: id
            },
            dataType: 'json',
            success: function(response) {
                ...
                $('#modalEditRPPM').on('shown.bs.modal', function(e) {
                    $('#namaKelas').focus();
                });
                $('#modalEditRPPM').modal('show');
            }
        })
    }
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('RPPM/hapusRPPM_ajax') ?>",
                        data: {
                            rppmID: rppmID
                        },
                        dataType: "json",
