        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Edit Tema Program</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="updateTemaProgramSemester" method="POST" enctype="multipart/form-data">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <select data-placeholder="Pilih Promes" class="form-control form-control-select2" data-fouc name="promesNumber">
                                    ...
                                    <?php $queryGroup = $this->db->query("SELECT *FROM TBL_PROMESMAIN")->result_array();
