...
=======
<<<<<<< HEAD:application/views/page/old/masterOld/form/tambahSiswa.php
                        <label>NIS:</label>
                        <input type="text" name="nik" class="form-control" placeholder="NIS">
=======
...
>>>>>>> STPPA adding stppa sub lingkup:application/views/page/master/form/tambahProfilePegawai.php
                    </div>
                    <!-- Admin -->
