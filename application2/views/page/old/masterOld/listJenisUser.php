                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-warning" onclick="edit(<?php echo $q['jns_user_kd'] ?>)">Edit </button>
                                    <button onclick="hapus(<?php echo $q['jns_user_kd'] ?>)" class=" btn btn-sm btn-danger">Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div id="modalTambahJenisUser" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('MasterData/simpanJenisUser_ajax', ['class' => 'formSimpan']) ?>
...
<script>
    ...
    function edit(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('MasterData/formEditJenisUser') ?>",
            data: {
                jenisUserID: id
            },
            dataType: 'json',
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('MasterData/hapusJenisUser_ajax') ?>",
                        data: {
