                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-outline-success btn-sm" onclick="edit(<?php echo $q['thn_ajar_kd'] ?>)">Edit </button>
                                    <button onclick="hapus(<?php echo $q['thn_ajar_kd'] ?>)" class=" btn btn-sm btn-outline-danger">Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div id="modalTambahTahunPelajaran" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('TahunPelajaran/simpanTahunPelajaran_ajax', ['class' => 'formSimpan']) ?>
...
<script>
    ...
    function edit(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('TahunPelajaran/formEditTahunPelajaran') ?>",
            data: {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('TahunPelajaran/hapusTahunPelajaran_ajax') ?>",
                        data: {
