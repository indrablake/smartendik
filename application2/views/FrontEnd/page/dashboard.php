                ...
                <div class="owl-carousel owl-theme nav-inside" data-plugin-options="{'items': 1, 'autoplay': true, 'autoplayTimeout': 4000, 'margin': 10, 'loop': false, 'nav': true, 'dots': false}">
                    <div>
                        <div class=" border-0 p-0 d-block">
                            <div <?php $fileImage = base_url('uploads/Berita/5bb54079c2d8472f30fca3ce31872239.jpg') ?> style=" background-image: url('<?php echo $fileImage; ?>');height:300px;background-size: cover;  width: 100%;" alt="">
                    ...
                    <div>
                        <div class="border-0 p-0 d-block">
                            <div <?php $fileImage = base_url('uploads/Berita/66f0e6c5a78e7c7b2f0858a51abb07c9.jpeg') ?> style=" background-image: url('<?php echo $fileImage; ?>');height:300px;background-size: cover;  width: 100%;" alt="">
                                <div style="position: absolute;bottom:20px;left:20px">
                                    <h2 class="font-weight-bold text-color-light line-height-2 text-5 mb-0">
