    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="tambahRPPM" class="breadcrumb-elements-item">
                ...
                <table class="table datatable-basic" id="example">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td><?php echo $q['RPPM_STUDYYEAR']; ?></td>
                                <td><?php echo $q['CLASS_LEVEL'] . '-' . $q['CLASS_NAME']; ?></td>
                                <td><?php echo $q['RPPM_SEMESTER']; ?></td>
                                <td>
                                    <?php
                                    switch ($q['RPPM_MONTH']) {
                                        case 1:
                                ...
                                <td>
                                    <?php if ($q['RPPM_WEEK'] == 1 || $q['RPPM_WEEK'] == "I") {
                                        echo "I";
                                    } else if ($q['RPPM_WEEK'] == 2 || $q['RPPM_WEEK'] == "II") {
                                        echo "II";
                                    } else if ($q['RPPM_WEEK'] == 3 || $q['RPPM_WEEK'] == "III") {
                                        echo "III";
                                    } else if ($q['RPPM_WEEK'] == 4 || $q['RPPM_WEEK'] == "IV") {
                                        echo "IV";
                                    } ?>
                                </td>

                                <td class="text-center">
                                    <a href="detailRPPM?id=<?php echo $q['RPPM_ID']; ?>" class="btn btn-primary mt-1 btn-sm">Detail</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
