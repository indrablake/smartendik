                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="<?php echo base_url() ?>uploads/<?php echo $q['NP_IMAGELINK']; ?>" width="60px" alt=""></td>
                                <td><a href="editBerita?id=<?php echo $q['NP_ID'] ?>" class="btn btn-warning btn-sm"><i class="icon-pencil" style="font-size: 12px;"></i></a><a href="deleteBerita?id=<?php echo $q['NP_ID'] ?>" class="btn btn-danger btn-sm mt-1"><i class="icon-trash" style="font-size: 12px;"></i></a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
