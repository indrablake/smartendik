                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="deleteSubTemaProgramSemester?id=<?php echo $q['SUBTHEME_ID']; ?>" class="btn btn-danger mt-1 btn-sm">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                ...
                <form method="POST" action="updateTemaProgramSemester">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Semester" value="<?php echo $subtheme_name ?>" name="temaProgram">
                        </div>
