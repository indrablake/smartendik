            ...
            <div class="blog-posts single-post">
                <article class="post post-large blog-single-post border-0 m-0 p-0">
                    <div class="post-image ml-0" style="text-align: center;">
                        <a>
                            <img src="http://pokjawaspai.org/media_library/posts/welcome-image-1588195554053.jpg" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
                        </a>
                    </div>

                    <div class="post-content ml-0">
                        <h2 class="font-weight-bold"><a>Sambutan Ketua POKJAWAS PAI Nasional</a></h2>
                        <div class="post-meta">
                        ...
                        <p>Kecepatan dan kemudahan akses informasi dalam era digital suatu kenyataan yang berdampak pada perubahan pola hidup manusia saat ini termasuk pada cara belajar dan mengajar serta pengawasan dalam dunia pendidikan, Pokjawas PAI Nasional menyikapi dengan positif perkembangan teknologi saat ini dengan membangun website Pokjawas sebagi media komunikasi dan edukasi pengawas PAI untuk meningkatkan kualitas pembelajaran PAI yang bermutu dan berdaya saing, dengan adanya ''website pokjawaspai.org'' yang dikelola oleh pokjawaspai nasional, kami berharap semua Pengawas PAI dapat memanfaatkan website ini untuk meningkatkan kompetensi diri secara berkelanjutan tanpa dibatasi jarak dan waktu, semoga bermanfaat</p>
