                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-outline-success btn-sm" onclick="edit(<?php echo $q['agama_kd'] ?>)">Edit </button>

                                    <button onclick="hapus(<?php echo $q['agama_kd'] ?>)" class="btn btn-sm btn-sm btn-outline-danger">Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div id="modalTambahAgama" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('Agama/simpanAgama_ajax', ['class' => 'formSimpan']) ?>
...
<script>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.sukses) {
                    ...
                    window.location.href = ("<?= base_url('Agama/listAgama'); ?>")
                }
            },
    ...
    function edit(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('Agama/formEditAgama') ?>",
            data: {
                agamaID: id
            },
            dataType: 'json',
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('Agama/hapusAgama_ajax') ?>",
                        data: {
                            agamaID: agamaID
                        },
                        dataType: "json",
