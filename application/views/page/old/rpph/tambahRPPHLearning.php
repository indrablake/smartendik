...
<div class="content">
    ...
    <div id="modalTambahLearn" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('RPPH/simpanRPPHLearning_ajax', ['class' => 'formSimpan']) ?>
...
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.sukses) {
                        ...
                        $('#modalTambahLearn').modal('hide');
                        $('#modalTambahLearn').modal({
                            backdrop: 'false',
                            keyboard: 'true',
                            show: 'false'
                        });
    ...
    function edit(id) {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('RPPH/formEditRPPHLearning') ?>",
            data: {
                rpphLearnID: id
            },
            dataType: 'json',
            success: function(response) {
                ...
                $('#modalEditRPPHLearning').on('shown.bs.modal', function(e) {
                    $('#namaKelas').focus();
                });
                $('#modalEditRPPHLearning').modal('show');
            }
        })
    }
    ...
    $('.formHapus').submit(function(e) {
        ...
        if (jumlahData.length == 0) {
            ...
            swal({
                    title: "Hapus",
                    text: ` ${jumlahData.length}   Pembelajaran RPPH,Yakin menghapus data  ?`,
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('RPPH/hapusRPPHLearning_ajax') ?>",
                        data: {
                            rpphLearnID: rpphLearnID
                        },
                        dataType: "json",
                        success: function(response) {
                            if (response.sukses) {
