...
<div class="content">
    ...
    <div id="modalTambahTeknik" class="modal fade" tabindex="-1">
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <?php echo form_open('RPPH/simpanRPPHTeknik_ajax', ['class' => 'formSimpan']) ?>
...
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.sukses) {
                        ...
                        $('#modalTambahTeknik').modal('hide');
                        $('#modalTambahTeknik').modal({
                            backdrop: 'false',
                            keyboard: 'true',
                            show: 'false'
                        });
    ...
    function edit(id) {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('RPPH/formEditRPPHTeknik') ?>",
            data: {
                rpphTeknikID: id
            },
            dataType: 'json',
            success: function(response) {
                ...
                $('#modalEditRPPHTeknik').on('shown.bs.modal', function(e) {
                    $('#namaKelas').focus();
                });
                $('#modalEditRPPHTeknik').modal('show');
            }
        })
    }


    function hapus(rpphTeknikID) {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('RPPH/hapusRPPHTeknik_ajax') ?>",
                        data: {
                            rpphTeknikID: rpphTeknikID
                        },
                        dataType: "json",
                        success: function(response) {
                            if (response.sukses) {
