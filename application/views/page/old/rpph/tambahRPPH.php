    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="listRPPH" class="breadcrumb-elements-item">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="simpanRPPH" method="POST" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <select data-placeholder="Pilih Tahun" class="form-control form-control-select2" name="tahunRPPH" data-fouc id="tahunAjaran" onchange="tahun()">
                            ...
                            <div class="form-group">
                                <label>Bulan:</label>
                                <select data-placeholder="Pilih Bulan" class="form-control form-control-select2" data-fouc name="bulanRPPH">
                            ...
                            <div class="form-group">
                                <label>Minggu:</label>
                                <select data-placeholder="Pilih Minggu" class="form-control form-control-select2" data-fouc name="mingguRPPH">
                                    <?php $month = array('', 'Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember');
                                    for ($i = 1; $i <= 4; $i++) :
                                    ?>
                                        <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
