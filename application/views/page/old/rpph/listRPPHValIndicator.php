        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="tambahTemaProgramSemester" class="breadcrumb-elements-item">
                    ...
                    Tambah RPPH Valuation Indicator
                </a>
            </div>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $q['RPPHVALINDICATOR_DESC']; ?></td>
                                <td><?php echo $q['RPPHVALINDICATOR_INDEX']; ?></td>

                                <td class="text-center">
                                    <a href="deleteRPPH?id=<?php echo $q['RPPHVALINDICATOR_INDEX']; ?>" class="btn btn-danger mt-1 btn-sm">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
