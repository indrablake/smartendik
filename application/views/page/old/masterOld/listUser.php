                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    if (empty($result->profile_kd)) { ?>
                                        <a class="btn btn-sm btn-warning" href="<?php echo base_url() ?>MasterData/DetailProfile?id=<?= $q['user_kd']; ?>">Profile </a>
                                        <button onclick="hapusUserAjax(<?php echo $q['user_kd'] ?>)" class="btn btn-sm btn-sm btn-danger">Hapus</button>
                                    <?php } else {
                                    ?>
                                        <a class="btn btn-sm btn-warning" href="<?php echo base_url() ?>MasterData/DetailProfileEdit?profileID=<?= $q['profile_kd'] ?>">Edit Profile </a>
...
<script>
    ...
    function edit(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('MasterData/formEditUser') ?>",
            data: {
                userID: id
            },
            dataType: 'json',
