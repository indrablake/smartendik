            ...
            <form id="submit">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $dataProfileUser->profile_tgl_lahir; ?>" class="form-control" id="anytime-month-numeric" name="tanggal_lahir" value="<?= date("d/m/Y"); ?>">
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#submit').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>MasterData/updatePegawaiProfile_ajax',
                type: "post",
