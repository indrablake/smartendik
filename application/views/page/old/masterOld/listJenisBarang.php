                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-warning" onclick="edit(<?php echo $q['jns_brg_kd'] ?>)">Edit </button>
                                    <button onclick="hapus(<?php echo $q['jns_brg_kd'] ?>)" class=" btn btn-sm btn-danger">Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div id="modalTambahJenisBarang" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('MasterData/simpanJenisBarang_ajax', ['class' => 'formSimpan']) ?>
...
<script>
    ...
    function edit(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('MasterData/formEditJenisBarang') ?>",
            data: {
                jenisBarangID: id
            },
            dataType: 'json',
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('MasterData/hapusJenisBarang_ajax') ?>",
                        data: {
