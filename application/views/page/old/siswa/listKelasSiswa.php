                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $q['CLASS_NAME'] . '-' . $q['CLASS_LEVEL']; ?></td>
                                <td class="text-center"><?php echo $q['jumlah']; ?></td>
                                <td><a href="<?php echo base_url(); ?>Siswa/detailKelasSiswa?kelasID=<?php echo $q['CLASS_ID']; ?>" class="btn btn-sm btn-sm btn-primary">Detail</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
