                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-warning" onclick="edit(<?php echo $q['STD_ID'] ?>)">Edit </button>
                                    <a href="" class="btn btn-sm btn-sm btn-primary">Detail</a>
                                    <button onclick="hapus(<?php echo $q['STD_ID'] ?>)" class="btn btn-sm btn-sm btn-danger">Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
