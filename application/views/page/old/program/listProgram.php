    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <button type="button" class="btn btn-default" id="tombolTambah">
...
<div class="content">
    ...
    <?php echo form_open('Program/deleteMultiple_ajax', ['class' => 'formHapus']); ?>
...
<script>
    function showData() {
        table = $('#my_data').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url('program/ambilData') ?>",
                "type": "POST"
            },
    ...
    $('.formHapus').submit(function(e) {
        ...
        if (jumlahData.length == 0) {
            ...
            swal({
                    title: "Hapus",
                    text: ` ${jumlahData.length}   Program Semester,Yakin menghapus data  ?`,
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
    ...
    $('#tombolTambah').click(function(e) {
        $.ajax({
            type: "post",
            url: "<?= base_url('Program/formTambah') ?>",
            dataType: 'json',
            success: function(response) {
                if (response.sukses) {
    ...
    function edit(id) {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('Program/formEditProgram') ?>",
            data: {
                promesID: id
            },
            dataType: 'json',
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('Program/hapusData_ajax') ?>",
                        data: {
                            promesID: promesID
                        },
                        dataType: "json",
