                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <!-- <div class="input-group">
                                    ...
                                    <input type="text" class="form-control daterange-single" name="tanggal_expire" value="<?= date("d-m-Y"); ?>">
                                </div> -->
                                <div class="input-group">
                                    <span class="input-group-prepend">
                                        <span class="input-group-text"><i class="icon-calendar3"></i></span>
                                    </span>
                                    <input type="text" class="form-control" id="anytime-month-numeric" name="tanggal_expire" value="<?= date("d/m/Y"); ?>">
                                </div>
                            </div>
                            <div class="form-group">
