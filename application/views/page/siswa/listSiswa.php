    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="<?php echo base_url() ?>Siswa/tambahSiswa" class="btn btn-default">Tambah Data <i class="icon-play3 ml-2"></i></a>
            </div>
        </div>
    </div>
</div>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button onclick="detail(<?php echo $q['profile_kd'] ?>)" class="btn btn-sm btn-outline-success">Detail</button>
                                    <button onclick="hapus(<?php echo $q['profile_kd'] ?>)" class="btn btn-sm  btn-outline-danger">Hapus</button>
                                    <a href="<?php echo base_url() ?>Siswa/siswaProfileEdit?profileID=<?php echo $q['profile_kd']; ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                                </td>
                            </tr>
                        <?php
                        endforeach; ?>
...
<script>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.sukses) {
                    ...
                    window.location.href = ("<?= base_url('Siswa/listUser'); ?>")
                }
            },
    ...
    function detail(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('Siswa/formDetailSiswa') ?>",
            data: {
                siswaID: id
            },
            dataType: 'json',
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('Siswa/hapusUser_ajax') ?>",
                        data: {
                            userID: userID
                        },
                        dataType: "json",
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('Siswa/hapusUserPermanen_ajax') ?>",
                        data: {
                            userID: userID
                        },
                        dataType: "json",
