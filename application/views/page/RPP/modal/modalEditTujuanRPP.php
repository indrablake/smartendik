    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                <h5 class="modal-title">Edit Tujuan Pembelajaran RPP</h5>
            ...
            <div class="modal-body">
                ...
                <?php echo form_open('RPP/updateTujuanRPP_ajax', ['class' => 'formSimpan']) ?>
                <fieldset>
                    <input type="hidden" name="rppTPID" value="<?= $rppTPID; ?>">
                    <div class="col-md-12">
                        <label>RPP:</label>
                    </div>
