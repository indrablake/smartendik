<div id="modalDetailRPP" class="modal fade modalDetailRPP" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                <h5 class="modal-title">Detail RPP</h5>
            ...
            <div class="modal-body">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <select data-placeholder="Pilih Kelas" class="form-control" name="tahunAjaran" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Sub Tema RPPH" name="rppSemester" disabled value="<?= $semester; ?>">
                    </div>

                    <div class="form-group">
                        <label>Materi Pokok:</label>
                        <textarea data-sample-short rows="2" name="materiPokok" disabled placeholder="Materi Pokok" id="ckeditor2" required><?= $materiPokok; ?></textarea>
                    </div>
