<div id="modalEditMediaRPP" class="modal fade modalEditMediaRPP" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open('RPP/updateMediaRPP_ajax', ['class' => 'formSimpan']) ?>
                <fieldset>
                    <input type="hidden" name="rppMediaID" value="<?= $rppMediaID; ?>">
                    <div class="col-md-12">
                        <label>RPP:</label>
                    </div>
