    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="<?php echo base_url() ?>RPP/formTambahMediaRPP" class="btn btn-default btn-sm">Tambah Data</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function load_data(query) {
        $.ajax({
            url: "<?php echo base_url(); ?>RPP/fetchMedia",
            method: "POST",
            data: {
                query: query
            },
...
<script>
    function showData() {
        table = $('#my_data').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url('rpp/ambilDataMediaRPP') ?>",
                "type": "POST",
                "data": {
                    "rppmpID": $("#rpphid").val()
                }
    ...
    function edit(id) {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('RPP/formEditMediaRPP') ?>",
            data: {
                rppMediaID: id
            },
            dataType: 'json',
            success: function(response) {
                ...
                $('#modalEditMediaRPP').on('shown.bs.modal', function(e) {
                    $('#namaKelas').focus();
                });
                $('#modalEditMediaRPP').modal('show');
            }
        })
    }
    ...
    function hapus(rppmpID) {

        swal({
                title: "Hapus",
                text: "Yakin menghapus data media RPP ?",
                icon: "warning",
                buttons: true,
                dangerMode: true,
                showCancelButton: true,
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('RPP/hapusMediaRPP_ajax') ?>",
                        data: {
                            rppmpID: rppmpID
                        },
                        dataType: "json",
