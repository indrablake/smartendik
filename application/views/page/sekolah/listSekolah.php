    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item">List Sekolah</span>
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="<?= base_url(); ?>Sekolah/tambahSekolah" class="btn btn-default">Tambah Data <i class="icon-play3 ml-2"></i></a>
            </div>
        </div>
    </div>
</div>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-outline-success" href="<?= base_url(); ?>Sekolah/formEditSekolah?id=<?php echo $q['sekolah_kd'] ?>">Edit </a>
                                    <button onclick="hapus(<?php echo $q['sekolah_kd'] ?>)" class=" btn btn-sm btn-outline-danger">Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('Sekolah/hapusSekolah_ajax') ?>",
                        data: {
                            sekolahID: sekolahID
                        },
                        dataType: "json",
