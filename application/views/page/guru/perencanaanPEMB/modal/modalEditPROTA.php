<div id="modalEditPROTA" class="modal fade modalEditPROTA" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit PROTA</h5>
                ...
                <form id="submitUpdate">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="protaID" value="<?php echo $prota_id; ?>">
                            <input type="text" name="prota" value="<?php echo $prota_name; ?>" class="form-control" placeholder="PROTA">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="file_protaOLD" value="<?php echo $prota_upload; ?>">
                            <input type="file" name="file_prota" class="form-input-styled">
                        </div>
...
<script>
    $('#submitUpdate').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url(); ?>guru/perencanaanPEMB/updatePROTA_ajax',
            type: "post",
