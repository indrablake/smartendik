<div id="modalEditSKL" class="modal fade modalEditSKL" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit SKL</h5>
                ...
                <form id="submitUpdate">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="sklID" value="<?php echo $skl_id; ?>">
                            <input type="text" name="skl" value="<?php echo $skl_name; ?>" class="form-control" placeholder="SKL">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="file_sklOLD" value="<?php echo $skl_upload; ?>">
                            <input type="file" name="file_skl" class="form-input-styled">
                        </div>
...
<script>
    $('#submitUpdate').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url(); ?>guru/perencanaanPEMB/updateSKL_ajax',
            type: "post",
