<div id="modalEditKI" class="modal fade modalEditKI" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit KI</h5>
                ...
                <form id="submitUpdate">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label>Nama KI:</label>
                            <input type="hidden" name="kiID" value="<?php echo $ki_id; ?>">
                            <input type="text" name="ki" value="<?php echo $ki_name; ?>" class="form-control" placeholder="KI">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="file_kiOLD" value="<?php echo $ki_upload; ?>">
                            <input type="file" name="file_ki" class="form-input-styled">
                        </div>
...
<script>
    $('#submitUpdate').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url(); ?>guru/perencanaanPEMB/updateKI_ajax',
            type: "post",
