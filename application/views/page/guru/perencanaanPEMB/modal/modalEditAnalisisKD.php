<div id="modalEditAnalisisKD" class="modal fade modalEditAnalisisKD" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Analisis KD</h5>
                ...
                <form id="submitUpdate">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label>Nama Analisis KD:</label>
                            <input type="hidden" name="analisisKDID" value="<?php echo $analisisKD_id; ?>">
                            <input type="text" name="analisisKD" value="<?php echo $analisisKD_name; ?>" class="form-control" placeholder="AnalisisKD">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="file_analisisKDOLD" value="<?php echo $analisisKD_upload; ?>">
                            <input type="file" name="file_analisisKD" class="form-input-styled">
                        </div>
...
<script>
    $('#submitUpdate').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url(); ?>guru/perencanaanPEMB/updateAnalisisKD_ajax',
            type: "post",
            ...
            success: function(data) {
                ...
                swal({
                    icon: 'success',
                    title: "Konfirmasi",
                    text: "Analisis KD Berhasil Di Update"
                });
