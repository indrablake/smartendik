            ...
            <div class="card" style="padding: 1em;">
                ...
                <table class="table datatable-basic table-bordered" id="example">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        foreach ($listRPP as $rpp) : ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td><?php echo $rpp['rpp_name'] ?></td>
                                <td><?php echo $rpp['jenjang_nm'] ?></td>
                                <td><?php echo $rpp['kelas'] ?></td>
                                <td><?php echo $rpp['semester'] ?></td>
                                <td style="text-align: center;">
                                    <?php if ($this->session->userdata('jenisUser') == 'Guru') { ?>
                                        ...
                                        if ($rpp['rpp_status'] == '0') {
                                        ?>
                                            <a href="<?php echo base_url() ?>guru/PerencanaanPEMB/downloadRPP/<?php echo $rpp['rpp_id'] ?>" class="btn btn-success btn-sm">Download</a>
                                            <button class="btn btn-sm btn-warning" onclick="edit(<?php echo $rpp['rpp_id'] ?>)">Edit</button>
                                            <button class="btn btn-sm btn-primary" onclick="publikasi(<?php echo $rpp['rpp_id'] ?>)">Publikasi</button>
                                        <?php
                                        } else { ?>
                                            <a href="<?php echo base_url() ?>guru/PerencanaanPEMB/downloadRPP/<?php echo $rpp['rpp_id'] ?>" class="btn btn-success btn-sm">Download</a>
                                            <button class="btn btn-sm btn-danger" onclick="hapus(<?php echo $rpp['rpp_id'] ?>)">Hapus</button>
                                    <?php }
                                    } ?>
                                </td>
                            </tr>
...
<!-- Tambah Data -->
<div id="modalTambahRPP" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data RPP</h5>
            ...
            <form id="submit">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="rpp" class="form-control" placeholder="RPP">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="file_rpp" class="form-input-styled" data-fouc="">
                    </div>
                </div>
...
<script>
    ...
    $('#submit').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url(); ?>guru/PerencanaanPEMB/simpanRPP_ajax',
            type: "post",
    ...
    function edit(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('guru/PerencanaanPEMB/formEditRPP') ?>",
            data: {
                RPPID: id
            },
            dataType: 'json',
    ...
    function hapus(RPPID) {
        swal({
                title: "Hapus",
                text: "Yarppn menghapus data RPP ?",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('guru/PerencanaanPEMB/hapusRPP_ajax') ?>",
                        data: {
                            RPPID: RPPID
                        },
                        dataType: "json",
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('guru/PerencanaanPEMB/hapusRPPPermanen_ajax') ?>",
                        data: {
                            RPPID: RPPID
                        },
                        dataType: "json",
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('guru/perencanaanPEMB/updateRPPPublikasi') ?>",
                        data: {
                            rppID: rppID
                        },
                        dataType: "json",
