                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-outline-success btn-sm" onclick="edit(<?php echo $q['kelas_kd'] ?>)">Edit </button>
                                    <button onclick="hapus(<?php echo $q['kelas_kd'] ?>)" class=" btn btn-sm btn-outline-danger">Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div id="modalTambahKelas" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('Kelas/simpanKelas_ajax', ['class' => 'formSimpan']) ?>
...
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.sukses) {
                        ...
                        window.location.href = ("<?= base_url('Kelas/listKelas'); ?>")
                    }
                },
    ...
    function edit(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('Kelas/formEditKelas') ?>",
            data: {
                jenisKelas: id
            },
            dataType: 'json',
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('Kelas/hapusKelas_ajax') ?>",
                        data: {
